...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        try {
            obj.insert("insert into client_tbl values('" + tb_cname.Text + "','" + tb_addr.Text + "','" + ddlcountry.SelectedItem.Text + "','" + ddlstate.SelectedItem.Text + "','" + ddlcity.SelectedItem.Text + "','" + tb_mno.Text + "','" + tb_mailid.Text + "','" + tb_order_description.Text + "')");

            lblmsg.Visible = true;
            lblmsg.Text = "Client Registered";
        }
        catch (Exception ex)
        {
